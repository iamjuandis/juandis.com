  ...
  frostbyte: {
    ...
    sections: {
      ...
      firstProcess: {
        ...
        title: 'The output',
        content: `After a very intense month of observation, interviews and field research, we were not only focused on the visualization problem, but we need to focus on a SaaS solution. Frostbyte customers, needed to visualize clearly and in realtime all of their sensors and alerts data. Based on technology and budget, we couldn't deliver a full and customizable product, so we focused on a simple, usable and efficient way to perceive the current storehouses environmental status.`,
      },
      nextProcess: {
        alignment: 'mid-up',
        columns: 1,
