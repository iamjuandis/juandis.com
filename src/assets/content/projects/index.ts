...
export const PROJECTS: ProjectsType = {
  ...
  frostbyte: {
    ...
    conclusion: {
      alignment: 'wide-bottom',
      columns: 1,
      content: `The complexity and huge amount of data in monitoring environment variables would result in a challenging task to spend the fewer resources, equipment, and money possible, so one of the main solutions for those industries was a real-time dashboard, simple, reliable, and useful.<br/><br/>
    ...
    sections: {
      ...
      firstProcess: {
        ...
        title: 'The output',
        content: `After a very intense month of observation, interviews, and field research, we were not only focused on the visualization problem, but we need to focus on a SaaS solution. Frostbyte customers needed to visualize clearly and in real-time all of their sensors and alerts data. Based on technology and budget, we couldn't deliver a full and customizable product, so we focused on a simple, usable, and efficient way to perceive the current storehouses environmental status.`,
      },
      nextProcess: {
        alignment: 'mid-up',
        columns: 1,
        title: 'We got',
        content: `<ul class="big-letter">
        <li><strong>+91%</strong> less time to collect and visualize data</li>
        <li><strong>+20K</strong> data points per week</li>
        <li><strong>+400%</strong> more revenue</li>
        </ul>`,
      },
    },
    skills: ['Product Design', 'Product Management'],
    slug: 'frostbyte',
    years: { first: 2019, last: 2020 },
  },
  ...
  weareangular: {
    ...
    conclusion: {
      alignment: 'wide-bottom',
      columns: 2,
      content: `This is one of those projects that I'm very proud of. Not only for the results behind that but also for the process, execution, and decisions made to do it better. I had the challenge to take the driver seat and get a diverse team together to involve strategy, marketing, business, design, and technology decisions to refresh our whole company.<br/><br/>
